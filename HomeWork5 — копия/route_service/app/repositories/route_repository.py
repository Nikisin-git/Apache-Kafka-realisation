...
class RouteRepository:
    ...
    async def create_route(self, start: str, end: str, waypoints: list[str], distance_length: str) -> Route:
        ...
        return Route(route_id=route_id, start_point=start, end_point=end, waypoints=waypoints, distance= distance_length)
